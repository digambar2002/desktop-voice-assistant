...
detector = cv2.CascadeClassifier('D:\\Projects\\pyhton\\assistant\\authenticate\\haarcascade_frontalface_default.xml')
...
while True:
    ...
    for (x,y,w,h) in faces:
        ...
        cv2.imwrite("authenticate\\samples\\face." + str(face_id) + '.' + str(count) + ".jpg", converted_image[y:y+h,x:x+w])
